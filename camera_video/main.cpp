...
int main()
{
    ...
    nvvidconvflip-method=0 ! video/x-raw, \
    ...
    udpsink host=203.234.58.155 port=8001 sync=false";
    ...
    nvvidconv ! nvv4l2h264enc insert-sps-pps=true ! \
    h264parse ! rtph264pay pt=96 ! \
    udpsink host=203.234.58.155 port=8002 sync=false";
    ...
    nvvidconv ! nvv4l2h264enc insert-sps-pps=true ! \
    h264parse ! rtph264pay pt=96 ! \
    udpsink host=203.234.58.155 port=8003 sync=false";
    ...
    while(true) {
        ...
        threshold(gray, thres, 125, 255, THRESH_BINARY);
